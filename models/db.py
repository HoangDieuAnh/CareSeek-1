...
db.define_table('WorkWith',
    Field('Carer', 'reference auth_user'),
...
db.define_table('UserRating',
   Field('CareSeeker', 'reference auth_user'),
   Field('Carer', 'reference auth_user'),
   Field('RatingTime', 'datetime')
   )
db.define_table('RatingMetric',
   Field('Criteria', 'string'),
   Field('DataInputType', 'string')
   )
db.define_table('Scores',
   Field('URID', 'reference UserRating'),
   Field('RMID', 'reference RatingMetric'),
   Field('Score', 'integer')
   )
...
db.define_table('CareSeeker',
    ...
    Field('FirstName', 'reference auth_user'),
    Field('LastName', 'reference auth_user'),
    Field('Password', 'reference auth_user'),
    Field('Description', 'text'),
    Field('ProfilePic', 'upload'),
    Field('Age', 'reference auth_user'),
	Field('Phone', 'reference auth_user'),
    Field('Gender', 'reference auth_user'),
)
